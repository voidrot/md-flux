...
```typescript
import type { CreateInlineComment201Response } from ''
...
const example = {
  ...
  "versions": null,
  "links": null,
} satisfies CreateInlineComment201Response
...
const exampleParsed = JSON.parse(exampleJSON) as CreateInlineComment201Response
