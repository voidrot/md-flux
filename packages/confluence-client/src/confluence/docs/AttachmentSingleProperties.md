...
```typescript
import type { AttachmentSingleProperties } from ''
...
const example = {
  ...
  "meta": null,
  "links": null,
} satisfies AttachmentSingleProperties
...
const exampleParsed = JSON.parse(exampleJSON) as AttachmentSingleProperties
