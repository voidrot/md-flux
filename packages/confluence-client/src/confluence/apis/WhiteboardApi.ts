...
import {
    CreateWhiteboard200ResponseFromJSON,
    CreateWhiteboard200ResponseToJSON,
    CreateWhiteboardRequestFromJSON,
    CreateWhiteboardRequestToJSON,
} from '../models/index';
...
export class WhiteboardApi extends runtime.BaseAPI {
    ...
    async createWhiteboardRaw(requestParameters: CreateWhiteboardOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateWhiteboard200Response>> {
        ...
        const response = await this.request({
            ...
            body: CreateWhiteboardRequestToJSON(requestParameters['createWhiteboardRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateWhiteboard200ResponseFromJSON(jsonValue));
    }
