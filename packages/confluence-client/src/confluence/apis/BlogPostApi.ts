...
import {
    BlogPostSortOrderFromJSON,
    BlogPostSortOrderToJSON,
    CreateBlogPost200ResponseFromJSON,
    CreateBlogPost200ResponseToJSON,
    CreateBlogPostRequestFromJSON,
    CreateBlogPostRequestToJSON,
    MultiEntityResultBlogPostFromJSON,
    MultiEntityResultBlogPostToJSON,
    ...
    UpdateBlogPostRequestFromJSON,
    UpdateBlogPostRequestToJSON,
} from '../models/index';
...
export class BlogPostApi extends runtime.BaseAPI {
    ...
    async createBlogPostRaw(requestParameters: CreateBlogPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateBlogPost200Response>> {
        ...
        const response = await this.request({
            ...
            body: CreateBlogPostRequestToJSON(requestParameters['createBlogPostRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateBlogPost200ResponseFromJSON(jsonValue));
    }
    ...
    async getBlogPostsRaw(requestParameters: GetBlogPostsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultBlogPost>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultBlogPostFromJSON(jsonValue));
    }
    ...
    async updateBlogPostRaw(requestParameters: UpdateBlogPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateBlogPost200Response>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateBlogPostRequestToJSON(requestParameters['updateBlogPostRequest']),
        }, initOverrides);
