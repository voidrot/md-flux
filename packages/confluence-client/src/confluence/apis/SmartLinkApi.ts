...
import {
    CreateSmartLink200ResponseFromJSON,
    CreateSmartLink200ResponseToJSON,
    CreateSmartLinkRequestFromJSON,
    CreateSmartLinkRequestToJSON,
} from '../models/index';
...
export class SmartLinkApi extends runtime.BaseAPI {
    ...
    async createSmartLinkRaw(requestParameters: CreateSmartLinkOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateSmartLink200Response>> {
        ...
        const response = await this.request({
            ...
            body: CreateSmartLinkRequestToJSON(requestParameters['createSmartLinkRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateSmartLink200ResponseFromJSON(jsonValue));
    }
