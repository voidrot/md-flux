...
import {
    ...
    ContentPropertyCreateRequestFromJSON,
    ContentPropertyCreateRequestToJSON,
    ContentPropertySortOrderFromJSON,
    ContentPropertySortOrderToJSON,
    ContentPropertyUpdateRequestFromJSON,
    ContentPropertyUpdateRequestToJSON,
    MultiEntityResultContentPropertyFromJSON,
    MultiEntityResultContentPropertyToJSON,
} from '../models/index';
...
export class ContentPropertiesApi extends runtime.BaseAPI {
    ...
    async createAttachmentPropertyRaw(requestParameters: CreateAttachmentPropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContentProperty>> {
        ...
        const response = await this.request({
            ...
            body: ContentPropertyCreateRequestToJSON(requestParameters['contentPropertyCreateRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ContentPropertyFromJSON(jsonValue));
    }
    ...
    async getAttachmentContentPropertiesRaw(requestParameters: GetAttachmentContentPropertiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultContentProperty>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultContentPropertyFromJSON(jsonValue));
    }
    ...
    async updateAttachmentPropertyByIdRaw(requestParameters: UpdateAttachmentPropertyByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContentProperty>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ContentPropertyUpdateRequestToJSON(requestParameters['contentPropertyUpdateRequest']),
        }, initOverrides);
