...
import {
    AttachmentSortOrderFromJSON,
    AttachmentSortOrderToJSON,
    GetAttachmentById200ResponseFromJSON,
    GetAttachmentById200ResponseToJSON,
    MultiEntityResultAttachmentFromJSON,
    MultiEntityResultAttachmentToJSON,
} from '../models/index';
...
export class AttachmentApi extends runtime.BaseAPI {
    ...
    async getAttachmentByIdRaw(requestParameters: GetAttachmentByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetAttachmentById200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetAttachmentById200ResponseFromJSON(jsonValue));
    }
    ...
    async getAttachmentsRaw(requestParameters: GetAttachmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultAttachment>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultAttachmentFromJSON(jsonValue));
    }
