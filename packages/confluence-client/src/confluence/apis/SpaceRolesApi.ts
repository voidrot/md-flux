...
import {
    CreateSpaceRoleRequestFromJSON,
    CreateSpaceRoleRequestToJSON,
    DeleteSpaceRoleResponseFromJSON,
    DeleteSpaceRoleResponseToJSON,
    GetSpaceRoleMode200ResponseFromJSON,
    GetSpaceRoleMode200ResponseToJSON,
    GetSpaceRolesById200ResponseFromJSON,
    GetSpaceRolesById200ResponseToJSON,
    MultiEntityResultSpaceRoleFromJSON,
    MultiEntityResultSpaceRoleToJSON,
    MultiEntityResultSpaceRoleAssignmentFromJSON,
    MultiEntityResultSpaceRoleAssignmentToJSON,
    PrincipalTypeFromJSON,
    PrincipalTypeToJSON,
    SetSpaceRoleAssignmentsRequestInnerFromJSON,
    SetSpaceRoleAssignmentsRequestInnerToJSON,
    SpaceRoleFromJSON,
    SpaceRoleToJSON,
    UpdateSpaceRoleRequestFromJSON,
    UpdateSpaceRoleRequestToJSON,
    UpdateSpaceRoleResponseFromJSON,
    UpdateSpaceRoleResponseToJSON,
} from '../models/index';
...
export class SpaceRolesApi extends runtime.BaseAPI {
    ...
    async createSpaceRoleRaw(requestParameters: CreateSpaceRoleOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SpaceRole>> {
        ...
        const response = await this.request({
            ...
            body: CreateSpaceRoleRequestToJSON(requestParameters['createSpaceRoleRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SpaceRoleFromJSON(jsonValue));
    }
    ...
    async deleteSpaceRoleRaw(requestParameters: DeleteSpaceRoleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteSpaceRoleResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => DeleteSpaceRoleResponseFromJSON(jsonValue));
    }
    ...
    async getAvailableSpaceRolesRaw(requestParameters: GetAvailableSpaceRolesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultSpaceRole>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultSpaceRoleFromJSON(jsonValue));
    }
    ...
    async getSpaceRoleAssignmentsRaw(requestParameters: GetSpaceRoleAssignmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultSpaceRoleAssignment>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultSpaceRoleAssignmentFromJSON(jsonValue));
    }
    ...
    async getSpaceRoleModeRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSpaceRoleMode200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSpaceRoleMode200ResponseFromJSON(jsonValue));
    }
    ...
    async getSpaceRolesByIdRaw(requestParameters: GetSpaceRolesByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSpaceRolesById200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSpaceRolesById200ResponseFromJSON(jsonValue));
    }
    ...
    async setSpaceRoleAssignmentsRaw(requestParameters: SetSpaceRoleAssignmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultSpaceRoleAssignment>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters['setSpaceRoleAssignmentsRequestInner']!.map(SetSpaceRoleAssignmentsRequestInnerToJSON),
        }, initOverrides);
    ...
    async updateSpaceRoleRaw(requestParameters: UpdateSpaceRoleOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateSpaceRoleResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateSpaceRoleRequestToJSON(requestParameters['updateSpaceRoleRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => UpdateSpaceRoleResponseFromJSON(jsonValue));
    }
