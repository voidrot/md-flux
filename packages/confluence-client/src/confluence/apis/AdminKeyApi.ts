...
import {
    AdminKeyResponseFromJSON,
    AdminKeyResponseToJSON,
    EnableAdminKeyRequestFromJSON,
    EnableAdminKeyRequestToJSON,
} from '../models/index';
...
export class AdminKeyApi extends runtime.BaseAPI {
    ...
    async enableAdminKeyRaw(requestParameters: EnableAdminKeyOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AdminKeyResponse>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: EnableAdminKeyRequestToJSON(requestParameters['enableAdminKeyRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => AdminKeyResponseFromJSON(jsonValue));
    }
