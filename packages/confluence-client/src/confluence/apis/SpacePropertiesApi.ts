...
import {
    MultiEntityResultSpacePropertyFromJSON,
    MultiEntityResultSpacePropertyToJSON,
    SpacePropertyFromJSON,
    SpacePropertyToJSON,
    SpacePropertyCreateRequestFromJSON,
    SpacePropertyCreateRequestToJSON,
    SpacePropertyUpdateRequestFromJSON,
    SpacePropertyUpdateRequestToJSON,
} from '../models/index';
...
export class SpacePropertiesApi extends runtime.BaseAPI {
    ...
    async createSpacePropertyRaw(requestParameters: CreateSpacePropertyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SpaceProperty>> {
        ...
        const response = await this.request({
            ...
            body: SpacePropertyCreateRequestToJSON(requestParameters['spacePropertyCreateRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => SpacePropertyFromJSON(jsonValue));
    }
    ...
    async getSpacePropertiesRaw(requestParameters: GetSpacePropertiesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultSpaceProperty>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultSpacePropertyFromJSON(jsonValue));
    }
    ...
    async updateSpacePropertyByIdRaw(requestParameters: UpdateSpacePropertyByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SpaceProperty>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: SpacePropertyUpdateRequestToJSON(requestParameters['spacePropertyUpdateRequest']),
        }, initOverrides);
