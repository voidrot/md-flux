...
import {
    CheckAccessByEmail200ResponseFromJSON,
    CheckAccessByEmail200ResponseToJSON,
    CheckAccessByEmailRequestFromJSON,
    CheckAccessByEmailRequestToJSON,
    CreateBulkUserLookupRequestFromJSON,
    CreateBulkUserLookupRequestToJSON,
    MultiEntityResultUserFromJSON,
    MultiEntityResultUserToJSON,
} from '../models/index';
...
export class UserApi extends runtime.BaseAPI {
    ...
    async checkAccessByEmailRaw(requestParameters: CheckAccessByEmailOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckAccessByEmail200Response>> {
        ...
        const response = await this.request({
            ...
            body: CheckAccessByEmailRequestToJSON(requestParameters['checkAccessByEmailRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CheckAccessByEmail200ResponseFromJSON(jsonValue));
    }
    ...
    async createBulkUserLookupRaw(requestParameters: CreateBulkUserLookupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultUser>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateBulkUserLookupRequestToJSON(requestParameters['createBulkUserLookupRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultUserFromJSON(jsonValue));
    }
