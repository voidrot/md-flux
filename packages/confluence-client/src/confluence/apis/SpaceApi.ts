...
import {
    ...
    GetSpaceById200ResponseFromJSON,
    GetSpaceById200ResponseToJSON,
    MultiEntityResultSpaceFromJSON,
    MultiEntityResultSpaceToJSON,
    SpaceDescriptionBodyRepresentationFromJSON,
    SpaceDescriptionBodyRepresentationToJSON,
    SpaceSortOrderFromJSON,
    SpaceSortOrderToJSON,
} from '../models/index';
...
export class SpaceApi extends runtime.BaseAPI {
    ...
    async getSpaceByIdRaw(requestParameters: GetSpaceByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSpaceById200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GetSpaceById200ResponseFromJSON(jsonValue));
    }
    ...
    async getSpacesRaw(requestParameters: GetSpacesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultSpace>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultSpaceFromJSON(jsonValue));
    }
