...
import {
    CreateCustomContent201ResponseFromJSON,
    CreateCustomContent201ResponseToJSON,
    CreateCustomContentRequestFromJSON,
    CreateCustomContentRequestToJSON,
    CustomContentBodyRepresentationFromJSON,
    CustomContentBodyRepresentationToJSON,
    CustomContentBodyRepresentationSingleFromJSON,
    CustomContentBodyRepresentationSingleToJSON,
    CustomContentSortOrderFromJSON,
    CustomContentSortOrderToJSON,
    MultiEntityResultCustomContentFromJSON,
    MultiEntityResultCustomContentToJSON,
    UpdateCustomContentRequestFromJSON,
    UpdateCustomContentRequestToJSON,
} from '../models/index';
...
export class CustomContentApi extends runtime.BaseAPI {
    ...
    async createCustomContentRaw(requestParameters: CreateCustomContentOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateCustomContent201Response>> {
        ...
        const response = await this.request({
            ...
            body: CreateCustomContentRequestToJSON(requestParameters['createCustomContentRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CreateCustomContent201ResponseFromJSON(jsonValue));
    }
    ...
    async getCustomContentByTypeRaw(requestParameters: GetCustomContentByTypeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<MultiEntityResultCustomContent>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => MultiEntityResultCustomContentFromJSON(jsonValue));
    }
    ...
    async updateCustomContentRaw(requestParameters: UpdateCustomContentOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateCustomContent201Response>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateCustomContentRequestToJSON(requestParameters['updateCustomContentRequest']),
        }, initOverrides);
