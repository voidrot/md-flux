...
import {
    PostRedactPageRequestFromJSON,
    PostRedactPageRequestToJSON,
    RedactionResponseFromJSON,
    RedactionResponseToJSON,
} from '../models/index';
...
export class RedactionsApi extends runtime.BaseAPI {
    ...
    async postRedactBlogRaw(requestParameters: PostRedactBlogRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RedactionResponse>> {
        ...
        const response = await this.request({
            ...
            body: PostRedactPageRequestToJSON(requestParameters['postRedactPageRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => RedactionResponseFromJSON(jsonValue));
    }
