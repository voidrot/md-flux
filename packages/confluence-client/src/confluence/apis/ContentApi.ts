...
import {
    ContentIdToContentTypeResponseFromJSON,
    ContentIdToContentTypeResponseToJSON,
    ConvertContentIdsToContentTypesRequestFromJSON,
    ConvertContentIdsToContentTypesRequestToJSON,
} from '../models/index';
...
export class ContentApi extends runtime.BaseAPI {
    ...
    async convertContentIdsToContentTypesRaw(requestParameters: ConvertContentIdsToContentTypesOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ContentIdToContentTypeResponse>> {
        ...
        const response = await this.request({
            ...
            body: ConvertContentIdsToContentTypesRequestToJSON(requestParameters['convertContentIdsToContentTypesRequest']),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => ContentIdToContentTypeResponseFromJSON(jsonValue));
    }
